function [positions,xmins,fmins,iter,s_conditions] = susd_search(x0,obj_fun,z_des,max_iter,max_FEs, susd_gain, form_gain, form_dist, gain_funcs)
    ...
    for iter=1:max_iter
        ...
        for swarm=1:swarm_count
            ...
            x(:,:,swarm) = x(:,:,swarm) + susd_gain*u +...
                           form_gain*dist_form(form_dist,x(:,:,swarm));
